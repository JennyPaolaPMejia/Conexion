...
import { iniciarSesionUsuario, obtenerDatosUsuario } from "../../services/authServices"
...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const { user } = await iniciarSesionUsuario(email, password)
      ...
      const perfil = await obtenerDatosUsuario(user.id)

      if (perfil.tipo_de_usuario === "empresa") {
      ...
      <article className="contenedor__articulo">
        <form className="articulo__formulario" onSubmit={handleLogin}>
          ...
          <div className="formulario__iniciar sesion">
            <button className="iniciar__sesion" type="submit" disabled={loading}>
