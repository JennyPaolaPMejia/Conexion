...
import { orquestarRegistro } from "../../services/authServices"
...
function Register() {
  ...
  const mapExperienceToNumber = (exp) => {
    const map = {
      "0-1": 0, "1-3": 1, "3-5": 3, "5-10": 5, "10+": 10
    }
    return map[exp] || 0
  }

  const mapCompanySizeToNumber = (size) => {
    const map = {
      "1-10": 10, "11-50": 50, "51-200": 200, "201-500": 500, "500+": 1000
    }
  ...
  const handleRegister = async () => {
    ...
    setLoading(true)
    try {
      await orquestarRegistro(
        accountType, 
        formData, 
        {
          experiencia: mapExperienceToNumber,
          tamanoEmpresa: mapCompanySizeToNumber
        }
      )
    ...
    <div className="registro__contenedor">
      <div className="registro__card">
            ...
            <>
              <div className="formulario__grupo">
                ...
                <div className="input-wrapper">
                  ...
                  >
                    <option value="">Seleccionar</option>
                    <option value="10">1-10 empleados</option>
                    <option value="50">11-50 empleados</option>
                    <option value="200">51-200 empleados</option>
                    <option value="500">201-500 empleados</option>
                    <option value="600">Más de 500 empleados</option>
                  </select>
                </div>
              </div>
              <div className="formulario__grupo">
        ...
        <div className="terms-box">
          <div className="checkbox-wrapper">
            ...
            <label htmlFor="terms" className="terms-text">
              Acepto los <a href="#" className="terms-link">términos y condiciones</a> y la <a href="#" className="terms-link">política de privacidad</a> de Conexión. Entiendo que mis datos serán tratados de acuerdo con la normativa de protección de datos.
            </label>
          </div>
        </div>
        ...
        <div className="formulario__login">
          <p>¿Ya tienes cuenta? <Link className="login" to="/login">inicia sesión aquí</Link></p>
        </div>
      </div>
    </div>
  )
